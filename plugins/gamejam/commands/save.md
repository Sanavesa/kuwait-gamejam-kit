...
---
Save my current progress as a checkpoint, clean and beginner-safe. (Under the hood this is a git commit, but **keep git invisible to me**: in anything you say back, call it a save point or checkpoint, never a commit, and don't show me raw git commands or output.)
